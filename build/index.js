...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        switch (name) {
            ...
            case "set_state": {
                const { token, selector = "all", ...stateParams } = args;
            ...
            case "toggle_power": {
                const { token, selector = "all", duration } = args;
            ...
            case "breathe_effect": {
                const { token, selector = "all", ...effectParams } = args;
            ...
            case "activate_scene": {
                const { token, scene_uuid, duration, fast } = args;
            ...
            case "effects_off": {
                const { token, selector = "all", power_off } = args;
